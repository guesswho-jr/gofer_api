"""
Django settings for Gofer_main project.
...
SECRET_KEY = 'django-insecure-ec8yyj-)h#=wf@pb7)z9et@$uveju!t!8ypd_7!1*+btre(3qy'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=2), # change that s
    'REFRESH_TOKEN_LIFETIME': timedelta(days=10),
    # "ACCESS_TOKEN_LIFETIME": timedelta(seconds=1), # change that s
